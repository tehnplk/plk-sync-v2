...
API_FIELDS = ("hoscode", "visit_date", "count_case_dx_rx_same_prev_vst")
SQL_FILES = {
    "mysql": "remed_summary_15d_my.sql",
    "postgres": "remed_summary_15d_pg.sql",
}
...
def normalize_record(row: dict[str, Any]) -> dict[str, Any]:
    record = {field: to_json_value(row.get(field)) for field in API_FIELDS}
    ...
    record["count_case_dx_rx_same_prev_vst"] = int(record["count_case_dx_rx_same_prev_vst"] or 0)
    return record
